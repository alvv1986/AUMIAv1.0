...
df = xr.open_dataset("/home/angel/Documents/iag-usp/modis/methane_project/v6.0_CH4_TOTAL_NO_FIRES_2018.0.1x0.1.nc")
...
ch4[ch4 == 0] = np.nan
levels = MaxNLocator(nbins=30).tick_values(1,16) 
...
m.drawmapboundary()
x1, y1 = m(x, y)
cs = m.contourf(x1, y1, ch4[4]*10**10, cmap='YlOrRd', levels=levels)
