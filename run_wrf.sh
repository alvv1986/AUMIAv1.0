...
if [ $month -eq 4 ];then cmonth=APR; idx=03; fdx=21; fi
...
cday1=`date -u +%d -d "${year}-${cmonth}-${cday} 3 day" `
cmonth1=`date -u +%m -d "${year}-${cmonth}-${cday} 3 day" `
year1=`date -u +%Y -d "${year}-${cmonth}-${cday} 3 day" `
